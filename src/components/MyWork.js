...
const MyWork = () => {
  return (
    <div className=" snap-start lg:px-40 lg:grid lg:grid-cols-12 lg:h-screen lg:items-center">
      ...
      <div className=" hidden lg:flex lg:flex-row lg:flex-wrap lg:justify-between lg:items-center lg:gap-8 col-span-12 lg:col-span-8">
